...
mod tests {
    ...
    fn test_two_party_sign() {
        ...
        let keypair= party_one::PaillierKeyPair::generate();
        let cipher_party_one_share = party_one::paillier_encrypted_share(&keypair.ek, &party_one_private_share_gen);
        ...
        let partial_sig = party_two::PartialSig::compute(&ec_context, &keypair.ek, &cipher_party_one_share,
